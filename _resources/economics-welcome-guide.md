---
title: "Economics Welcome Guide"
category: "Economics"
description: "Surviving the first-year economics course sequence (Math Camp, Micro, Econometrics) that students across departments take together."
pinned: false
toc: true
toc_items:
...
If you do NOT have a comprehensive exam (likely in Marketing, Accounting, Management, etc.), then even if you feel underprepared and struggle on exams, there are seemingly no hard rules that would have you dismissed. The [good-standing requirement]({{ '/resources/guidelines-for-good-standing/' | relative_url }}) expects that you will have a minimum of a B- in all courses with an expected average of A-- but in practice the class averages are low and the curve is generous, so even a rough raw score on a midterm often still lands you at A- once the curve is applied. Even if you fail the course, depending on your specification, it may not matter (although you may need to retake Econ) as you only need to pass 2 Econ courses to meet minor requirements.
