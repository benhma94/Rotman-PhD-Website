---
title: "Finance Welcome Guide"
category: "Finance"
description: "A practical guide to the first year for incoming Rotman Finance PhD students."
access: finance
pinned: false
toc: true
toc_items:
  ...
  - id: toronto
    title: "Living in Toronto"
  - id: sshrc
    title: "SSHRC funding"
  - id: quebec
    title: "Quebec bursaries"
---

## Welcome
{: #welcome}

Congratulations on getting into the PhD! This guide exists because onboarding at the start of the program can feel a bit thin, and the goal is simply to make the transition easier for incoming students. It covers the practical, day-to-day things more directly than the standard welcome letter does, with a focus on the first year for Finance students who take the economics course sequence.
...
- **If you lose:** You re-apply next year.

### Writing the proposal

- **Make it credible.** Get in touch with a potential supervisor and convince the committee you'll actually carry out the project (have the skills, maybe a bit of preparatory work). Otherwise you risk the classic "too early, too vague" comment.
- **Find the balance.** The committee isn't composed of PhD professors in your field, but they're also far from naive. A good test is whether colleagues from other fields understand and value the idea.
- **Every word counts.** Space is very limited -- no filler, only valuable information.
- **Check the formatting.** It would be a shame to lose points or get disqualified over formatting or word counts, so verify the application carefully.
